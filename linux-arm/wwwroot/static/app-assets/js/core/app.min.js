        ...
        (p(o).on("scroll", function () {
            ...
            p(o).on("load", function () {
                                    ...
                                    p(".main-menu-content .nav-item a").on(
                                        ...
                                        function () {
                                            p(".main-menu-content .menu-livicon").length &&
                                                (p(".main-menu-content .menu-livicon").stopLiviconEvo(),
                                                    p(this).find(".menu-livicon").playLiviconEvo());
                                        }
                                    );
                            },
                        });
                ...
                !1 === p.app.nav.initialized && p.app.nav.init({ speed: 300 }),
                    ...
                    p(".main-menu-content li.sidebar-group-active .menu-livicon").length &&
                    e(p(".main-menu-content li.sidebar-group-active .menu-livicon"));
                var n = u.data("menu");
                "horizontal-menu" != n &&
                    !1 === a &&
                    p(".main-menu-content")
                ...
                if (
                    (t.css("height", s),
                        u.hasClass("boxed-layout") && u.hasClass("vertical-overlay-menu"))
                ) {
                    ...
                    p(".char-textarea").on("keyup", function (e) {
                        !(function (e, a) {
                            ...
                            p(".char-count").html(e.value.length),
                                e.value.length > n
                                    ? (p(".counter-value").css("background-color", d),
                                        p(".char-textarea").css("color", d),
                                        p(".char-textarea").addClass("max-limit"))
                                    : (p(".counter-value").css("background-color", "#5A8DEE"),
            ...
            .init(
                {
                    debug: !1,
                    fallbackLng: "en",
                    backend: { loadPath: "/static/app-assets/data/locales/{{lng}}.json" },
                    returnObjects: !0,
                },
                function (e, a) {
        ...
        p(".search-input .input").on("keyup", function (e) {
            if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
                ...
                if (
                    ...
                    p.getJSON("../../../app-assets/data/" + h + ".json", function (e) {
                        for (var a = 0; a < e.listItems.length; a++) {
                            if (!0 === i) {
                                o = "";
                                for (
                                    var n = p("ul.nav.navbar-nav.bookmark-icons li"), t = 0;
                                    t < n.length;
                                    t++
                                ) {
                                    if (
                                        e.listItems[a].name ===
                                        n[t].firstChild.dataset.originalTitle
                                    ) {
                                        o = " warning";
                                        break;
                                    }
                        ...
                        for (a = 0; a < e.listItems.length; a++) {
                            if (!0 === i) {
                                o = "";
                                for (
                                    n = p("ul.nav.navbar-nav.bookmark-icons li"), t = 0;
                                    t < n.length;
                                    t++
                                )
                                    o =
                    ...
                    for (
                        var a = p("ul.nav.navbar-nav.bookmark-icons li"), n = "", t = 0;
                        t < a.length;
                        t++
                    )
                        n +=
